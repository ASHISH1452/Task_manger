...
function createCard(cardId, sectionId, taskValue){
    ...
    closeIcon.addEventListener("click", deleteTask); // Add event listener for delete
    card.append(task);
...
// adding event listeners for drop zones
document.getElementById("hold").addEventListener("drop", drop);
document.getElementById("hold").addEventListener("dragover", allowDrop);

document.getElementById("approved").addEventListener("drop", drop);
document.getElementById("approved").addEventListener("dragover", allowDrop);

document.getElementById("review").addEventListener("drop", drop);
document.getElementById("review").addEventListener("dragover", allowDrop);
